...
// Source: github.com/sv-tools/mongoifc (interfaces: ChangeStream,Client,ClientEncryption,Collection,Cursor,Database,DistinctResult,GridFSBucket,GridFSDownloadStream,GridFSUploadStream,IndexView,SearchIndexView,Session,SingleResult)
//
