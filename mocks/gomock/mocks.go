...
// Source: github.com/sv-tools/mongoifc (interfaces: ChangeStream,Client,Collection,Cursor,Database,IndexView,Session,SingleResult)
...
func (m *MockSession) WithTransaction(arg0 context.Context, arg1 func(mongo.SessionContext) (interface{}, error), arg2 ...*options.TransactionOptions) (interface{}, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
