...
// NewCursor creates a new instance of Cursor. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewCursor(t testing.TB) *Cursor {
	mock := &Cursor{}
	mock.Mock.Test(t)
