...
// NewCollection creates a new instance of Collection. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewCollection(t testing.TB) *Collection {
	mock := &Collection{}
	mock.Mock.Test(t)
