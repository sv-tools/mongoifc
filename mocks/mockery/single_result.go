...
// NewSingleResult creates a new instance of SingleResult. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSingleResult(t testing.TB) *SingleResult {
	mock := &SingleResult{}
	mock.Mock.Test(t)
