...
// NewChangeStream creates a new instance of ChangeStream. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewChangeStream(t testing.TB) *ChangeStream {
	mock := &ChangeStream{}
	mock.Mock.Test(t)
