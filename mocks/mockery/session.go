...
func (_m *Session) AdvanceOperationTime(ts *bson.Timestamp) error {
	ret := _m.Called(ts)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*bson.Timestamp) error); ok {
		r0 = rf(ts)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *Session_AdvanceOperationTime_Call) Run(run func(ts *bson.Timestamp)) *Session_AdvanceOperationTime_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*bson.Timestamp))
	})
	return _c
}
...
func (_c *Session_AdvanceOperationTime_Call) RunAndReturn(run func(*bson.Timestamp) error) *Session_AdvanceOperationTime_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Session) OperationTime() *bson.Timestamp {
	ret := _m.Called()
...
func (_c *Session_OperationTime_Call) Return(_a0 *bson.Timestamp) *Session_OperationTime_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Session_OperationTime_Call) RunAndReturn(run func() *bson.Timestamp) *Session_OperationTime_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Session) StartTransaction(opts ...options.Lister[options.TransactionOptions]) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(...options.Lister[options.TransactionOptions]) error); ok {
		r0 = rf(opts...)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *Session_StartTransaction_Call) Run(run func(opts ...options.Lister[options.TransactionOptions])) *Session_StartTransaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]options.Lister[options.TransactionOptions], len(args)-0)
		for i, a := range args[0:] {
			if a != nil {
				variadicArgs[i] = a.(options.Lister[options.TransactionOptions])
			}
		}
		run(variadicArgs...)
	})
...
func (_c *Session_StartTransaction_Call) RunAndReturn(run func(...options.Lister[options.TransactionOptions]) error) *Session_StartTransaction_Call {
	_c.Call.Return(run)
	return _c
}

// WithTransaction provides a mock function with given fields: ctx, fn, opts
func (_m *Session) WithTransaction(ctx context.Context, fn func(context.Context) (interface{}, error), opts ...options.Lister[options.TransactionOptions]) (interface{}, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 interface{}
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, func(context.Context) (interface{}, error), ...options.Lister[options.TransactionOptions]) (interface{}, error)); ok {
		return rf(ctx, fn, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, func(context.Context) (interface{}, error), ...options.Lister[options.TransactionOptions]) interface{}); ok {
		r0 = rf(ctx, fn, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, func(context.Context) (interface{}, error), ...options.Lister[options.TransactionOptions]) error); ok {
		r1 = rf(ctx, fn, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Session_WithTransaction_Call) Run(run func(ctx context.Context, fn func(context.Context) (interface{}, error), opts ...options.Lister[options.TransactionOptions])) *Session_WithTransaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(func(context.Context) (interface{}, error)), variadicArgs...)
	})
	return _c
}
...
func (_c *Session_WithTransaction_Call) RunAndReturn(run func(context.Context, func(context.Context) (interface{}, error), ...options.Lister[options.TransactionOptions]) (interface{}, error)) *Session_WithTransaction_Call {
	_c.Call.Return(run)
	return _c
}
